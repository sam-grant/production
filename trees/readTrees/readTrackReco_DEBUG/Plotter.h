...
int main(int argc, char *argv[]){
  ...
  if (argc < 2){
    ...
    // fileNames.push_back("/unix/muons/g-2/omegaEU/Tracking/gm2rootTrees_ana_15922.root");
    // fileNames.push_back("/scratch/folders/junk/gm2rootTrees_ana.root");
    fileNames.push_back("../../produceTestTrees/trackReco/trackRecoTrees.root");///gm2/data/g2be/Production/Trees/Run1/trackRecoTrees_15921.root");
  }
