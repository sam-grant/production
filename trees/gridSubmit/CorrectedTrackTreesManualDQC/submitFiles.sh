...
pnfsOutDir=/pnfs/GM2/scratch/users/${USER}/TrackingTreesManualDQC/${run}
...
echo "Copied RunTrackingTrees.fcl, libgm2tracker_filters_ManualDQCFilter_module.so & libgm2analyses_strawtracker_TrackNTupBackwardsOnly_module.so to $pnfsOutDir"
