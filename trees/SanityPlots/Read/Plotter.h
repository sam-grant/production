...
Plotter::Plotter(TString input_file, TString output_file) : output_name(output_file) {
  ...
  if(output_name.Sizeof()<2) {
    ...
    output_name="../Plots/plots_"+dataset+"_"+run+".root";
  }
...
int main(int argc, char *argv[]){
  ...
  if (argc < 2){
    ...
    fileNames.push_back("/gm2/data/g2be/Production/Trees/Run1/trackRecoTrees_15921.root");//");//../run15921/trackAndTrackCaloTree_15921.root");
  }
