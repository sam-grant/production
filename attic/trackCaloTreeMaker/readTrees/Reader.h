...
class trackAndTrackCaloReader : public Reader {
 ...
 trackAndTrackCaloReader(TString filename, TString treename="tree"):
  Reader(filename, "trackAndTrackCalo", "tree"){
   ...
   Double_t        decayVertexPosR;    
   Double_t        decayVertexMom;
   Double_t        decayVertexMomX;
   Double_t        decayVertexMomY;
   Double_t        decayVertexMomZ;
   Double_t        decayVertexMomUnc;
   Double_t        decayVertexUncR;
   Double_t        decayVertexUncY;
   Double_t        decayVertexUncPR;
   Double_t        decayVertexUncPY;
   Double_t        caloVertexTime;
   Double_t        caloVertexPosX;
   Double_t        caloVertexPosY;
   Double_t        caloVertexPosZ;
   Double_t        caloVertexPosR;
   Double_t        caloVertexMom;
   Double_t        caloVertexMomX;
   Double_t        caloVertexMomY;
   Double_t        caloVertexMomZ;
   Double_t        caloVertexMomUnc;
   Double_t        caloVertexUncX;
   Double_t        caloVertexUncY;
   Double_t        caloVertexUncPX;
   Double_t        caloVertexUncPY;
   Double_t        minDriftTime;
   Double_t        maxDriftTime;
   Double_t        maxResidual;
   Double_t        decayExtrapolatedDistance;
   
   UInt_t          nCluMatches;
   Bool_t          passCaloVertexQuality[15];
   Bool_t          passPositronVertexQuality[15];
   Bool_t          passLostMuonVertexQuality[15];
   Bool_t          onCaloEdge[15];
   Int_t           clusterIslandNum[15];
   Int_t           clusterFillNum[15];
   Int_t           clusterCaloNum[15];
   Double_t        clusterTime[15];
   Double_t        clusterX[15];
   Double_t        clusterY[15];
   Double_t        clusterEnergy[15];
   Double_t        uncorrClusterEnergy[15];
   Double_t        EoverP[15];
   Double_t        uncorrEoverP[15];
   Double_t        logEoverP[15];
   Double_t        logUncorrEoverP[15];
   Int_t           nXtalHits[15];
   Int_t           xtalWithMaxE[15];
   Double_t        xtalMaxEnergyFrac[15];
   Double_t        caloVertexClusterTimeDiff[15];
   Double_t        caloVertexClusterRadialDiff[15];
   Double_t        trackClusterExtrapolatedDistance[15];
