...
void Plotter::InitHistos() {
  ...
  plot2D("radialPos_vs_time",6000,0,900,500,-250,250,"Radial decay vertex position [mm]", "Track time [ns]");
  plot2D("verticalPos_vs_time",6000,0,900,500,-100,100,"Vertical decay vertex position [mm]", "Track time [ns]");
